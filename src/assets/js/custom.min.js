$(function() {
    ...
    var set = function() {
        ...
        $(".navbar-brand span").hide(), $('.navbar-brand b').show(), $(".sidebartoggler i").addClass("ti-menu")) : ($("body").removeClass("mini-sidebar"),
    ...
    $(window).ready(set), $(window).on("resize", set), $(".sidebartoggler").on("click", function() {
        ...
        $(".navbar-brand span").show(), $('.navbar-brand b').hide()) : ($("body").trigger("resize"), $("body").addClass("mini-sidebar"),
